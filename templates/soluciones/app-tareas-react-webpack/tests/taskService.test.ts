...
// ============================================================
// Lab 12A.3: Tests del TaskService
...
describe('TaskService', () => {
  ...
  describe('filterByStatus', () => {
    it('should return filtered tasks by status', () => {
      ...
      const completed = service.createTask('Tarea 3', 'high');
      service.update(completed.id, { status: 'completed' });

      const pendingTasks = service.filterByStatus('pending');
